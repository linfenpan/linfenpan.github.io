    ...
    ;(function(POP, $){
        ...
        Confirm.prototype = {
            ctor: function(html, options){
                // 合并参数
                var options = $.extend({title: "提示", withClose: true, btns: [{}, {}]}, options || {});
                var defBtns = [{
                    text: "取消",
                    color: "cancel",
                    callback: function(){}
            ...
            createContent: function(content){
                ...
                var html = '<div class="pop-dialog-confirm pop-dialog-white">\
                                '+ (options.withClose ? '<a href="javascript:;" class="pop-dialog-close" data-role="close"></a>' : '') +'\
            ...
            getBtnClickFn: function(callback){
                ...
                return function(e){
                    var res = callback && callback.call(dialog, this, e, self);
                    if(res === false){
                        // 等待正确才关闭
