...
(function(WIN, DOC) {
  var CSS_PREFIX_MAP, DOWN, END_EVENT, IsTouch, LEFT, MAX_OPP_ALLOW_DISTANCE, MIN_ALLOW_DISTANCE, MOVE_EVENT, NULL, NUMBER_REG, RIGHT, START_EVENT, Slip, UNDEFINED, UP, X, XY, Y, entry, getTranslate, noop, setTransition, setTranslate;
  UNDEFINED = void 0;
  NULL = null;
  X = "x";
  Y = "y";
  ...
  Slip = (function() {
    ...
    Slip.prototype.onSliderEnd = function(event, data) {
      ...
      // }
      setTransition(ele, "all " + duration + "ms ease");
      if (isVerticalWebapp) {
    ...
    Slip.prototype.resetWebapp = function() {
      var ctx = this;
      ctx.destroy();
      ctx.init();
      ctx.webapp();
    ...
    Slip.prototype.webapp = function(elPages) {
      ...
      ele = this.ele;
      pageNum = this.pageNum;
      ele.style.height = "" + (WIN.innerHeight * pageNum) + "px";
